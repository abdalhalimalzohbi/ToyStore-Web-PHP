<div class="fashion_section">
   <div id="main_slider" class="carousel slide" data-ride="carousel">
      <div class="carousel-inner">
         ...
         <div class="container">
            <h1 class="fashion_taital"><?php echo ($_GET['Age'] . " games") ?></h1>
            <div class="fashion_section_2">
               <div class="row">
                  <?php
                  include_once("/connection/connect.php");

                  $queryAgeTable = "SELECT id FROM age WHERE name = '" . $_GET['Age'] . "'";
                  $resultAgeTable = mysqli_query($connexion, $queryAgeTable);
                  $ageRow = mysqli_fetch_array($resultAgeTable, MYSQLI_ASSOC);
                  $query_select = "select * from game where age= " . $ageRow['id'];
   ...
   function getcart(obj) {
      ...
      if (cart.length > 0) {
         ...
         for (var i = 0; i < parsedArray.length; i++) {
            ...
            img.src = parsedArray[i]["name"];
            img.alt = "Image"; // Provide alternative text for accessibility
